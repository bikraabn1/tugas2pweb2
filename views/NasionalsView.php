<?php
require_once "../classes/Nasionals.php"; //mengimport file Nasionals.php
$no = 1;
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="min-vw-100 min-vh-100">
    ...
    <main class="d-flex flex-column justify-content-center align-items-center">
        ...
        <table class="table table-primary w-75">
            ...
            <tbody>
                <?php foreach ($datas as $data) : //perulangan untuk menampilkan data yang di ambil menggunakan query?>
                    <th scope="row"><?= $no++  ?></th>
                    <td><?= $data['name']  ?></td>
