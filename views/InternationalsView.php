<?php
require_once "../classes/Internationals.php"; //mengimport file Internationals.php
$no = 1;
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="min-vw-100 min-vh-100">
    ...
    <main class="d-flex flex-column justify-content-center align-items-center">
        <h1 class="mb-5">Data Tabel Siswa Berprestasi Tingkat Internationals</h1>
        <table class="table table-primary w-75">
            ...
            <tbody>
                <?php foreach ($datas as $data) : //perulangan untuk menampilkan data dari array yang di ambil menggunakan query?>
                    <th scope="row"><?= $no++  ?></th>
                    <td><?= $data['name']  ?></td>
